  ...
  sectorPublico: [
    {
      ...
      entidades: [
        { 
          ...
          progreso: 75,
          tareas: [
            { nombre: "Aprobar política institucional", completada: true },
            { nombre: "Implementar NTP-ISO/IEC 42001:2025", completada: true },
            { nombre: "Publicar código fuente sistemas IA", completada: false },
            { nombre: "Conformar equipos multidisciplinarios", completada: true }
          ],
          requisitos: [
        ...
        { 
          ...
          progreso: 60,
          tareas: [
            { nombre: "Política de IA parlamentaria", completada: true },
            { nombre: "Evaluación de sistemas actuales", completada: false },
            { nombre: "Capacitación de personal", completada: true },
        ...
        { 
          ...
          progreso: 45,
          tareas: [
            { nombre: "Análisis de sistemas judiciales", completada: true },
            { nombre: "Política de IA judicial", completada: false },
            { nombre: "Implementación gradual", completada: false },
            { nombre: "Capacitación de jueces", completada: true }
          ],
          requisitos: [
    ...
    },
    {
      ...
      entidades: [
        { 
          ...
          progreso: 25,
          tareas: [
            { nombre: "Diagnóstico de sistemas IA", completada: true },
        ...
        { 
          ...
          progreso: 30,
          tareas: [
            { nombre: "Política IA educativa", completada: true },
            { nombre: "Sistemas de evaluación", completada: false },
            { nombre: "Investigación en IA", completada: true },
        ...
        { 
          ...
          progreso: 20,
          tareas: [
            { nombre: "Auditoría de sistemas IA", completada: true },
  ...
  hitosCriticos: [
    {
      ...
      descripcion: "Entrada en vigencia del Decreto Supremo 115-2025-PCM",
      estado: "completado",
      impacto: "Muy Alto"
    },
    {
      fecha: "8 de diciembre 2025",
      descripcion: "Vigencia de disposiciones específicas (90 días hábiles)",
      estado: "pendiente",
      impacto: "Alto"
    },
    {
    ...
    {
      fecha: "9 de septiembre 2026",
      descripcion: "Primer plazo sector privado (1 año)",
      estado: "pendiente",
      impacto: "Alto"
    },
    {
      fecha: "9 de septiembre 2027",
      descripcion: "Segundo plazo sector privado (2 años)",
      estado: "futuro",
      impacto: "Medio"
    },
    {
      fecha: "9 de septiembre 2028",
      descripcion: "Tercer plazo sector privado (3 años)",
      estado: "futuro",
      impacto: "Medio"
    },
    {
      fecha: "9 de septiembre 2029",
